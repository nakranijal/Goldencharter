package uk.co.goldencharter.utility;
...
import uk.co.goldencharter.drivermanager.ManageDriver;
import java.io.File;
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "src/main/java/uk/co/goldencharter/screenshots";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "src/main/java/uk/co/goldencharter/screenshots" + screenshotName + dateName + ".png";
